...
package Games::RolePlay::MapGen::Exporter::Image;
...
Games::RolePlay::MapGen::Exporter::Image - An image MapGen exporter.
...
=head1 SYNOPSIS
    ...
    generate  $map;
    export    $map( "filename.png" );
    export    $map( "filename.jpg" );
    export    $map( "filename.gif" );
    export    $map( "filename.gd" );
    export    $map( "filename.gd2" );
